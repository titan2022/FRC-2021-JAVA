...
import static frc.robot.subsystems.sim.PhysicsSim.*; // random()
...
class TalonSRXSimProfile extends SimProfile {
    ...
    public void run() {
        ...
        double busVoltage = 12 - outPerc * outPerc * 3/4 * random(0.95, 1.05);
        _talon.getSimCollection().setBusVoltage(busVoltage);
    }
}