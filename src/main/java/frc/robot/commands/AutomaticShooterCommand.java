...
public class AutomaticShooterCommand extends CommandBase{
    ...
    public AutomaticShooterCommand(ShooterSubsystem shooterSubsystem, SwerveDriveOdometryCommand swerveDriveOdometryCommand){
